    ...
    for k, row in results.pandas().xyxy[0].iterrows():
        ...
        if row.confidence >= 0.4:
            ...
            if colour in ["Plum (Traditional)", "Fandango", "Boysenberry", "Royal Fuchsia", "Mulberry", "Persian Pink", "Hot Pink", "Brilliant Rose", "Pale Magenta", "Sky Magenta", \
                ...
                colour = "RED"
                supp_index = 'supp_01'
            elif colour in ["Maya Blue", "Light Sky Blue", "Cornflower Blue", "United Nations Blue", "Dodger Blue", "Bleu De France", "Steel Blue", "Lapis Lazuli", "Honolulu Blue", \
                ...
                colour = "WHITE"
                supp_index = 'supp_04'
            elif colour in ["Hooker'S Green", "Viridian", "Feldgrau", "Cal Poly Green", "Stormcloud"]:
                colour = "GREEN"
                supp_index = 'supp_05'
            elif colour in ["Pistachio", "Fern Green", "Olive Drab (Web) (Olive Drab #3)", "Camouflage Green", "Dark Tan", "Android Green", "Apple Green"]:
                colour = "MINT"
                supp_index = 'supp_06'
            elif colour in ["Onyx", "Arsenic", "Outer Space", "Payne'S Gray", "Old Lavender", "Ucla Blue", "Davy'S Gray", "Light Slate Gray", "Cadet", "Quartz", "Purple Taupe", \
                            "Slate Gray", "Pastel Purple", "Dark Slate Blue"]:
                colour = "PURPLE"
                supp_index = 'supp_07'
            else:
                colour = "NONE"
