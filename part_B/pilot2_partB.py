...
third_supplement = "/home/w88166ig/PILOT_2/NAO_sdk_code/PILOT_2_FINAL/part_B/thirdBox.txt"  # modified this line
...
class Nao:
    ...
    def real_time_speech(self):
        ...
        while True:
            self.startMicrophonesRecording(record_path, 'wav', 16000, (0,0,1,0))
            time.sleep(2)
            self.take_picture()
            time.sleep(5)
            self.stopMicrophonesRecording()
            ...
            if speech_detected == True and average_intensity >= 25:
                ...
                if userspeech_stt == 'stop' or userspeech_stt == 'stop experiment':
                ...
                elif userspeech_stt in ["no", "No"]:
                    filename = open(third_supplement)
                    ...
                    with open(third_supplement) as f:
                        if 'red' in f.read():
                            ...
                            tmp = supp_index
                            print(supp_index)
                            self.tts.say("This supplement will help you with vision or dry skin. \\pau=500\\ you can ask me if you need to know more. \\pau=100\\ Otherwise, if you do not wish to, \\pau=50\\ please say stop") # modified this line
                        elif 'blue' in f.read():
                            supp_index = "supp_02"
                            tmp = supp_index
                            print(supp_index)
                            self.tts.say("This supplement will help you with symptoms like confusion \\pau=20\\, irritability \\pau=20\\, coordination, \\pau=20\\, lethargy \\pau=20\\ and fatigue. \\pau=50\\ you can ask me anything if you need to know more. \\pau=100\\ Otherwise, if you do not wish to, \\pau=50\\ please say stop") # modified this line
                        elif 'orange' in f.read():
                            supp_index = "supp_03"
                            tmp = supp_index
                            self.tts.say("This supplement will help you with tiredness \\pau=20\\, headaches \\pau=20\\, and concentration. \\pau=50\\ you can ask me anything if you need to know more. \\pau=100\\ Otherwise, if you do not wish to, \\pau=50\\ please say stop") # modified this line
                        elif 'white' in f.read():
                            supp_index = "supp_04"
                            tmp = supp_index
                            self.tts.say("This supplement will help you with the tingliness sensation \\pau=20\\, loss of appetite \\pau=20\\, and nausea and vomiting. \\pau=50\\ you can ask me anything if you need to know more. \\pau=100\\ Otherwise, if you do not wish to, \\pau=50\\ please say stop") # modified this line
                        elif 'green' in f.read():
                            supp_index = "supp_05"
                            tmp = supp_index
                            self.tts.say("This supplement will help you with extreme fatigue and weakness \\pau=20\\, pale skin \\pau=20\\, headache or dizziness, \\pau=20\\, cold hands and feet. \\pau=50\\ you can ask me anything if you need to know more. \\pau=100\\ Otherwise, if you do not wish to, \\pau=50\\ please say stop") # modified this line
                        elif 'mint' in f.read():
                            supp_index = "supp_06"
                            tmp = supp_index
                            self.tts.say("This supplement will help you with common colds \\pau=20\\, and flu \\pau=50\\ you can ask me anything if you need to know more. \\pau=100\\ Otherwise if you do not wish to, \\pau=50\\ please say stop") # modified this line
                        elif 'purple' in f.read():
                            supp_index = "supp_07"
                            tmp = supp_index
                            self.tts.say("This supplement will help you with fatigue \\pau=20\\, bone pain \\pau=20\\, muscle pain, \\pau=20\\, or mood changes and lack of sunshine. \\pau=50\\ you can ask me anything if you need to know more. \\pau=100\\ Otherwise, if you do not wish to, \\pau=50\\ please say stop") # modified this line

                        f.close()

                elif userspeech_stt == 'Sorry.. run again...':
                    self.tts.say("I am sorry \\pau=40\\ i did not understand you. \\pau=160\\ can you please repeat")
                ...
                if speech_detected == False or average_intensity < 30:
                    self.tts.say('Would you like to ask me something else? \\pau=30\\')
...
if __name__ == '__main__':
    robotIP='192.168.1.102' #192.168.1.102
    port='9559'
